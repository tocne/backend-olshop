...
<head>
    <meta charset="UTF-8">
    <title>{{ $documentationTitle ?? config('l5-swagger.documentation.default.title', 'API Documentation') }}</title>
...
<script>
    const urls = [];
    urls.push({name: "Default", url: "{{ route('l5-swagger.default.docs') }}"});
